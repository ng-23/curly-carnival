...
class AdamConfigSchema(Schema):
    ...
    beta1 = fields.Float(load_default=0.9)
    beta2 = fields.Float(load_default=0.999)
...
@register_schema('NumericSearchSpace', 'misc')
class NumericSearchSpaceSchema(Schema):
...
@register_schema('SearchSpace', 'misc')
class SearchSpaceConfigSchema(Schema):
    general_conf = fields.Dict(keys=fields.String(required=True), values=fields.Nested(NumericSearchSpaceSchema), required=True)
    model_conf = fields.Dict(keys=fields.String(required=True), values=fields.Nested(NumericSearchSpaceSchema), required=True)
